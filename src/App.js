...
import "./App.css";
import IncorrectProgressBar from "./IncorrectProgressBar";
...
function App() {
  ...
  return (
    <>
    <ProgressBar score = {score} total = {questions.length}/>
    <IncorrectProgressBar score = {score} total = {questions.length} currentQuestion= {currentQuestion} />
    <div className="app">
      {showScore ? (
